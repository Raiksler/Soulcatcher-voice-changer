...
<p>Для получения результата, необходимо сделать всего две вещи: Выбрать режим работы бота и отправить ему голосовое сообщение. Бот способен обрабатывать как свежезаписанные голосовые сообщения, так и пересланные из каких-либо источников.</p>
<p>Существует три режима работы: 
<ul>
 ...
 <li><b>Машинная переозвучка</b> - команда /resound. Бот распознает речь во входящем сообщении и отправит ответное голосовое сообщение, переозвучив этот текст при помощи Google Text-to_speech.</li>
